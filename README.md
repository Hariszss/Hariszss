### Hi, I'm Haris (Charalampos Zisis) 👋
...
I like problems where the model has to be trusted by people who aren't data scientists — clinicians, risk officers, auditors — which means interpretability and honest evaluation matter as much as raw accuracy.
...
- **Leakage-safe evaluation**: 5-fold stratified CV with imputation fit per-fold; hyperparameter sensitivity checked across a full grid (AUC spread of 0.006 — result isn't a tuning artifact).
